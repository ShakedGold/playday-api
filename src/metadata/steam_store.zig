...
const LOGO_URL_FORMAT = "https://cdn.cloudflare.steamstatic.com/steam/apps/{s}/logo.png";
const HERO_URL_FORMAT = "https://shared.steamstatic.com/store_item_assets/steam/apps/{s}/library_hero.jpg";
const GRID_URL_FORMAT = "https://shared.steamstatic.com/store_item_assets/steam/apps/{s}/library_600x900.jpg";
...
pub fn getMetadata(self: *SteamStoreMetadata, gameId: []u8) !models.extra_metadata.ExtraGameMetadata {
    const response = try self.client.get(LOGO_URL_FORMAT, .{gameId});
    _ = response;
